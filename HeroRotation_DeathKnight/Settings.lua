...
HR.GUISettings.APL.DeathKnight = {
  Commons = {
    ...
    RangeCheck = true, -- shows spells only when in range
  },
  Frost = {
    GCDasOffGCD = {
      -- Abilities
...
CreatePanelOption("CheckButton", CP_Deathknight, "APL.DeathKnight.Commons.InRange", "Show only abilities in range", "Enable this if you want to see only abilities which are in range");
